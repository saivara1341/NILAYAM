-- Nilayam Supabase setup for EXISTING projects
-- Run this whole file in the Supabase SQL editor.
-- It uses the non-destructive repair/setup scripts already in this repo.

-- 1. Core schema, tables, triggers, policies, marketplace view, payments, and profile/payment_methods support
...
-- 2. Profile repair/backfill for auth users and updated_at/profile trigger fixes
...
-- 3. ID verification fields and id-proofs storage bucket/policies
...
-- 4. Service providers, service reviews, tenant documents bucket/policies
...
-- 5. Manual payment proofs bucket/policies and receipt_url support
...
-- 6. Performance indexes and minor profile additions
